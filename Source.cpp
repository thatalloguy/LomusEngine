...
int main() {
	...
	Texture textures[]{
		...
		Texture("Resources/Maps/planksSpec.png", "specular", 1, GL_RED, GL_UNSIGNED_BYTE)
	};
	...
	Shader lightShader("Lomus/Shader/shaders/light.vert", "Lomus/Shader/shaders/light.frag");
